...
exports.execute = function (file, bin, func, args) {
    ...
    tmp.file(function (error, tmpParam, fd, cleanupParamCallback) {
        var tmpParamData = {
        ...
        fs.writeFile(tmpParam, tmpParamData, 'utf8', function () {
            tmp.file(function (error, tmpResult, fds, cleanupResultCallback) {
